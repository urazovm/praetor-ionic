module PraetorApp.Services {
    ...
    export class PraetorService {
        ...
        public static get $inject(): string[]{
            return ["$q", Utilities.ID, "$http", "$location", Services.Preferences.ID, UiHelper.ID];
        }
        ...
        constructor($q: ng.IQService, Utilities: Utilities, $http: ng.IHttpService, $location: ng.ILocationService, Preferences: Services.Preferences, UiHelper: UiHelper) {
            this.$q = $q;
            this.$http = $http;
