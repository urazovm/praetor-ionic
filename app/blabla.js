angular.module('praetor.controllers', ['ui.utils'])


.controller('DocumentyCtrl', function ($scope, $stateParams, $sce) {
...
.controller('HomeCtrl', function ($scope, $location, $ionicLoading, praetorService) {
    ...
    // Načte všechny spisy
    praetorService.getSpisDokumenty().then(function (d) {
        $scope.dokumenty = d.dokumenty;
        $ionicLoading.hide();
    });
